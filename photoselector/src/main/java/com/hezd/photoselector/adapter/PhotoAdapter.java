...
public class PhotoAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.photoCover = view.findViewById(R.id.cover_img);
            holder.photoTitle = view.findViewById(R.id.tv_title);
            holder.photoCount = view.findViewById(R.id.tv_count);
        ...
        if(file!=null&&file.exists()) {
            ...
            Glide.with(mContext).load(R.mipmap.ic_launcher).diskCacheStrategy(DiskCacheStrategy.NONE).centerCrop().into(holder.photoCover);
        }
